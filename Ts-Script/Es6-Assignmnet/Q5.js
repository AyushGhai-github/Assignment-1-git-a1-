...
const userFriends = (username, ...Hello) => {
    ...
    for (let i in Hello) {
        console.log("List of friends Ayush have:" + Hello[i]);
    }
};
let username = "userName is:Ayush";
userFriends(username, "Ayush", "Poonam", "Omkar", "Atharv");
...
let Names = ['Ayush', 'Poonam', 'Atharv', 'Omkar', 'Pradumnya'];
